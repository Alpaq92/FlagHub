...
extension Flag {
    ...
    public static let supportedCountryCodes: [String] = [
        ...
        "EU", "FI", "FJ", "FK", "FM", "FO", "FR", "GA", "GB", "GB-ENG",
        "GB-NIR", "GB-SCT", "GB-WLS", "GB-ZET", "GD", "GE", "GF", "GG", "GH", "GI",
        "GL", "GM", "GN", "GP", "GQ", "GR", "GS", "GT", "GU", "GW",
        "GY", "HK", "HM", "HN", "HR", "HT", "HU", "IC", "ID", "IE",
        ...
        "US", "US-CA", "UY", "UZ", "VA", "VC", "VE", "VG", "VI", "VN",
        "VU", "WF", "WS", "WW", "XK", "YE", "YT", "ZA", "ZM", "ZW"
    ]
